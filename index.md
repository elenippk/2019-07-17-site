...
venue: "Athens"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Iera Odos 84"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
